...
void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) deepfilter_livekit_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "DeepFilterPlugin");
  deep_filter_plugin_register_with_registrar(deepfilter_livekit_registrar);
